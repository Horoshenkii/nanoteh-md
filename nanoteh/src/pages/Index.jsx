...
const Index = () => {
  return (
    <section className='ml-3 mr-3 lg:ml-[400px] lg:mr-[100px] mt-[50px]'>
      <p className='text-2xl font-semibold text-[#4169E1] mb-5'>We have:</p>
      <ul className='grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 lg:gap-4'>
